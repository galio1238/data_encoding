# DE8A - ECDSA Implementation

## Overview
This is an ECDSA (Elliptic Curve Digital Signature Algorithm) implementation that generates and verifies digital signatures.

## Code

### Complete DE8A.java Implementation
...
**Command:** `java DE8A "Hello World"`

**Expected Output:**
```
e: -5a6e592bf40bdfbfb5fee8cc30484e6f29d39a40f4325cd4a84d88265260eb92
Q: (x_coordinate,
y_coordinate)
r: [signature_r_value]
s: [signature_s_value]
v: [verification_value]
```

### Test Run Screenshot
![Terminal Run Output](image.png)
